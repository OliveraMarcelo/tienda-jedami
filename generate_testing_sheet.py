...
VIEWS["🛍️ Catálogo"] = [
    ("CAT-001","Catálogo carga con productos y fotos",
     ...
     "Grilla de productos visible con fotos, nombres y precios",P,A,FU,""),

    ("CAT-002","Catálogo accesible sin iniciar sesión",
     "Ninguna precondición",
     "1. Navegar a /catalogo sin autenticación",
     "Catálogo visible y navegable sin requerir login",P,A,SE,""),

    ("CAT-003","Branding dinámico visible (nombre y logo)",
     "Branding configurado en el sistema (nombre, logo, colores)",
     "1. Navegar a /catalogo\n2. Verificar cabecera o navbar",
     "Nombre de la tienda y logo configurados visibles en la interfaz",P,M,FU,""),
    ...
    ("CAT-004","Filtrar productos por categoría",
     ...
     "Solo se muestran los productos de la categoría seleccionada",P,M,FU,""),

    ("CAT-005","Buscar producto por texto",
     "Al menos un producto cargado",
     "1. Usar el buscador del catálogo\n2. Escribir parte del nombre de un producto\n3. Verificar resultados",
     "Solo los productos que coinciden con el texto de búsqueda se muestran",P,M,FU,""),

    ("CAT-006","Búsqueda sin resultados muestra mensaje",
     "Buscador disponible",
     "1. Buscar un texto que no coincide con ningún producto (ej: 'xyzxyz')",
     "Mensaje visible: 'No se encontraron productos' o similar",P,M,UX,""),

    ("CAT-007","Banner del catálogo visible",
     "Al menos un banner activo configurado en el sistema",
     "1. Navegar a /catalogo\n2. Verificar zona de banners",
     "Banner o carrusel de imágenes visible en la parte superior del catálogo",P,M,FU,""),

    ("CAT-008","Anuncios personalizados visibles",
     "Al menos un anuncio activo configurado",
     "1. Navegar al catálogo\n2. Verificar sidebar o zona de anuncios",
     "Anuncios visibles con texto/imagen configurados por el admin",P,M,FU,""),

    ("CAT-009","Click en producto navega al detalle",
     "Al menos un producto en catálogo",
     "1. Click en cualquier producto del catálogo",
     "Navega a /catalogo/:id con el detalle del producto",P,A,NA,""),

    ("CAT-010","Catálogo sin productos muestra mensaje apropiado",
     "Sistema con catálogo vacío (caso borde)",
     "1. Si no hay productos activos, navegar a /catalogo",
     "Mensaje de 'Sin productos disponibles' o similar. Sin errores en consola",P,B,UX,""),

    ("CAT-011","Carga inicial con estado de loading",
     "Ninguna precondición",
     "1. Navegar a /catalogo y observar la carga",
     "Skeleton loader o spinner visible durante la carga. Sin saltos visuales",P,B,UX,""),

    ("CAT-012","Categoría 'Todas' muestra todos los productos",
     "Productos en múltiples categorías",
     "1. Seleccionar filtro 'Todas' o sin filtro\n2. Verificar productos mostrados",
     "Todos los productos activos visibles sin filtro aplicado",P,M,FU,""),
]
